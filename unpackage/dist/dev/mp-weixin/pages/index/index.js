...
var _default = {
  data: function data() {
    return {
      imgs: ['https://web-cjpdemo.oss-cn-guangzhou.aliyuncs.com/static/banner1.png', 'https://web-cjpdemo.oss-cn-guangzhou.aliyuncs.com/static/banner2.png'],
      interval: 3000,
      duration: 500,
      content: '这是测试版本~~~',
      noticeList: [],
        ...
        if (res.confirm) {
          ...
          uni.login({
            ...
            success: function success(event) {
              ...
              _request.default.post("/user/user/login", userLoginDTO).then(function (res) {
                // 请求成功，处理响应
